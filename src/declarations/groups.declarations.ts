...
export type Result_1 = { Ok: GroupResponse } | { Err: ApiError };
export type Result_2 = { Ok: GroupRole } | { Err: ApiError };
export type Result_3 = { Ok: Group } | { Err: ApiError };
export type Result_4 = { Ok: boolean } | { Err: ApiError };
export type Result_5 = { Ok: [Principal, Privacy] } | { Err: ApiError };
export type Result_6 = { Ok: PagedResponse } | { Err: ApiError };
export type Result_7 = { Ok: Array<GroupResponse> } | { Err: ApiError };
export type Result_8 = { Ok: null } | { Err: boolean };
...
export interface _SERVICE {
  ...
  add_role: ActorMethod<[Principal, string, string, bigint, Principal], Result_2>;
  delete_group: ActorMethod<[Principal, Principal], Result_3>;
  edit_group: ActorMethod<[Principal, UpdateGroup, Principal], Result_1>;
  edit_role_permissions: ActorMethod<[Principal, string, Array<PostPermission>, Principal], Result_4>;
  ...
  get_groups: ActorMethod<[bigint, bigint, Array<GroupFilter>, FilterType, GroupSort, boolean], Result_6>;
...
export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    add_group: IDL.Func([PostGroup, IDL.Principal, IDL.Opt(IDL.Text)], [Result_1], []),
    add_role: IDL.Func([IDL.Principal, IDL.Text, IDL.Text, IDL.Nat64, IDL.Principal], [Result_2], []),
    delete_group: IDL.Func([IDL.Principal, IDL.Principal], [Result_3], []),
    edit_group: IDL.Func([IDL.Principal, UpdateGroup, IDL.Principal], [Result_1], []),
    edit_role_permissions: IDL.Func([IDL.Principal, IDL.Text, IDL.Vec(PostPermission), IDL.Principal], [Result_4], []),
    ...
    get_group_owner_and_privacy: IDL.Func([IDL.Principal], [Result_5], ["query"]),
    get_group_roles: IDL.Func([IDL.Principal], [IDL.Vec(GroupRole)], ["query"]),
    get_groups: IDL.Func(
      [IDL.Nat64, IDL.Nat64, IDL.Vec(GroupFilter), FilterType, GroupSort, IDL.Bool],
      [Result_6],
      ["query"]
    ),
    get_groups_by_id: IDL.Func([IDL.Vec(IDL.Principal)], [Result_7], ["query"]),
    http_request: IDL.Func([HttpRequest], [HttpResponse], ["query"]),
    migration_add_groups: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Principal, Group))], [], []),
    remove_role: IDL.Func([IDL.Principal, IDL.Text, IDL.Principal], [Result_4], []),
    update_member_count: IDL.Func([IDL.Principal, IDL.Principal, IDL.Nat64], [Result_8], []),
  });
};
